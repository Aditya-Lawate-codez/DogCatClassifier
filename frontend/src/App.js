...
function App() {
  ...
  return (
    <>
      ...
      <p className="text-lg font-normal text-dark lg:text-xl">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <span className="text-dark">File Uploaded : {filename}</span>
